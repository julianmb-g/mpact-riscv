...
#ifndef THIRD_PARTY_MPACT_RISCV_RVA23U64_BIN_ENCODER_INTERFACE_H_
#define THIRD_PARTY_MPACT_RISCV_RVA23U64_BIN_ENCODER_INTERFACE_H_
...
// This file defines the class that implements the Rva23u64EncoderInterfaceBase.
...
class Rva23u64BinEncoderInterface : public Rva23u64EncoderInterfaceBase {
 public:
  Rva23u64BinEncoderInterface();
  Rva23u64BinEncoderInterface(const Rva23u64BinEncoderInterface&) = delete;
  Rva23u64BinEncoderInterface& operator=(const Rva23u64BinEncoderInterface&) =
      delete;
  ~Rva23u64BinEncoderInterface() override = default;
...
#endif  // THIRD_PARTY_MPACT_RISCV_RVA23U64_BIN_ENCODER_INTERFACE_H_
