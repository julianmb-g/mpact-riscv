...
#ifndef THIRD_PARTY_MPACT_RISCV_RVA23S64_ENCODING_H_
#define THIRD_PARTY_MPACT_RISCV_RVA23S64_ENCODING_H_
...
class Rva23s64Encoding : public Rva23s64EncodingBase,
                              public RiscVEncodingCommon {
 public:
  explicit Rva23s64Encoding(RiscVState* state);
  ~Rva23s64Encoding() override;
...
#endif  // THIRD_PARTY_MPACT_RISCV_RVA23S64_ENCODING_H_
